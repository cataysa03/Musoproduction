...
description: Generates high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use this when the user mentions creating a new skill, building a skill, or generating a skill.
---
