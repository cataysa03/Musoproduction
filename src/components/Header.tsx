  ...
  const navLinks = [
    {
      ...
      href: "/portfolio",
      submenu: [
        { name: "Photos", href: "/portfolio/photos" },
        { name: "Videos", href: "/portfolio/videos" }
      ]
    },
    ...
    >
      <div className="max-w-[1600px] mx-auto px-6 md:px-12 flex justify-between items-center">
        <Link href="/" className="flex items-center">
          <img src="/logo.png" alt="Logo" className="h-12 w-auto object-contain scale-[4] origin-left" />
        </Link>
        ...
        <button className="md:hidden text-neutral-cream">
